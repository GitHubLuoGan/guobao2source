...
//////////////////升级/////////////////////
            Utils.getInstances().pay(MoaiBaseSdk.sActivity, bConfig.payCode, new UnipayPayResultListener(){
				...
				public void PayResult(String paycode, int flag, int flag2,
					...
					case 1://success
						...
						resultCode=1;
			    		result="支付成功";
			    		Log.d("caocaocao","i am success"+error);
			    		Log.d("caocaocao","i am success"+flag2);
						break;
					...
					case 2://fail
						...
						resultCode=-1;
			    		result="支付失败";
			    		Log.d("caocaocao","i am failed"+error);
			    		Log.d("caocaocao","i am failed"+flag2);
						break;
					...
					case 3://cancel
						...
						resultCode=0;
			    		result="支付取消";
			    		Log.d("caocaocao","i am cancel"+error);
			    		Log.d("caocaocao","i am cancel"+flag2);
						break;
						
					default:
						resultCode=-2;
			    		result="未知的支付";
			    		Log.d("caocaocao","i am other"+error);
			    		Log.d("caocaocao","i am other"+flag2);
						break;
						}
			    	JsonObject jsonParms=new JsonObject();
