...
// CDSC_VIDEO_ENABLE_CONTROL END
	...
	//----------------------------------------------------------------//
		...
		CommonLog.i ( "MoaiMoviePlayer onCreate: Initializing Movie Player" );
	...
	public void onCreate ( Bundle savedInstanceState ) {
		...
		CommonLog.i ( "MoaiMoviePlayer onCreate: activity CREATED" );
...
//CDSC_VIDEO_ENABLE_CONTROL END
		...
		if (true)
		{
			...
			ibtn.setOnClickListener(new ImageButton.OnClickListener(){
				...
				public void onClick(View paramView) {
					...
					CommonLog.i ( "MoaiMoviePlayer onCompletion" );
		...
		CommonLog.i ( "MoaiMoviePlayer onCreate: Initializing video player with media URL " + url );
	...
	public void onPrepared ( MediaPlayer mediaPlayer ) {
		...
		CommonLog.i ( "MoaiMoviePlayer onPrepared" );
