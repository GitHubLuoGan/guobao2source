...
public class Moai {
	...
	private static String [] sExternalClasses = {
		...
		"com.ziplinegames.moai.CommonBaseSdk", 
...
//cdsc add end
	...
	public static void onNewIntent ( Intent intent ) {
		...
		for ( Class < ? > theClass : sAvailableClasses ) {
			...
			executeMethod ( theClass, null, "onNewIntent", new Class < ? > [] { Intent.class }, new Object [] { intent });
		}	
	}
...
//						);
	...
	public static void localNotificationInSeconds ( int seconds, String message, String [] keys, String [] values ) {
		...
		CommonLog.i ( "Moai localNotificationInSeconds: Adding notification alarm" );
