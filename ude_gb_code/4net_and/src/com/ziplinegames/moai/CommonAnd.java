...
public class CommonAnd  extends  CommonBaseSdk {
    ...
    public void ResultChannelInfo(){
        ...
        channelInfo.add("recBuyStyle", LogoActivity.recBuyStyle);
        channelInfo.add("chn", "mmand");
        channelInfo.add("isMoreGame",true);
        channelInfo.add("isMusicEnabled",isMusicEnable);
...
//更多游戏
    ...
    public static String V2_openMoreGame(JsonValue parms){
    	...
    	Log.d("commonSdk","V2_openMoreGame  and");
...
//是否退出时执行
    ...
    { 
        try { 
             ...
             Log.d("commonSdk","And Pay Start");
             Log.d("commonSdk","bConfig.useSms == " + bConfig.useSms);
             Log.d("commonSdk","bConfig.isRepeated == " + bConfig.isRepeated);
             Log.d("commonSdk","bConfig.billingIndex == " + bConfig.billingIndex);
             Log.d("commonSdk","OrderNo == " + OrderNo);
