...
*/
	...
	private class MoaiRenderer implements GLSurfaceView.Renderer {
		...
		public void onSurfaceChanged ( GL10 gl, int width, int height ) {
			...
			CommonLog.i ( "MoaiRenderer onSurfaceChanged: surface CHANGED" );
		...
		public void onSurfaceCreated ( GL10 gl, EGLConfig config ) {
			...
			CommonLog.i ( "MoaiRenderer onSurfaceCreated: surface CREATED" );
			...
			if ( !mRunScriptsExecuted ) {
				...
				mHandler.postAtFrontOfQueue ( new Runnable () {
					...
					public void run () {
						...
						CommonLog.i ( "MoaiRenderer onSurfaceCreated: Running game scripts" );
		...
		private void runScripts ( String [] filenames ) {
			...
			for ( String file : filenames ) {
				...
				CommonLog.i ( "MoaiRenderer runScripts: Running " + file + " script" );
