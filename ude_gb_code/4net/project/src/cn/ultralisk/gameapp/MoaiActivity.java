...
public class MoaiActivity extends Activity {
	...
	{
		CommonLog.d("from Lua: JsonAPI " + paramInJson);
		CommonLog.d(Moai.AKUJsonRpcCall("Hello Lua"));
		if (false) {
...
private static Handler hand = null;
	...
	//----------------------------------------------------------------//
	static {
		CommonLog.d ( "Loading libmoai.so" );
...
//CDSC end	
    ...
    protected void onCreate ( Bundle savedInstanceState ) {
		...
		CommonLog.i ( "MoaiActivity onCreate: activity CREATED" );
...
//CSDC_PATCH_POWER
		...
		try {
			...
			CommonLog.e ( "MoaiActivity onCreate: Unable to locate the application bundle" );
		}
		...
		if ( getFilesDir () != null ) {
			...
			CommonLog.e ( "MoaiActivity onCreate: Unable to set the document directory" );
		}
...
//CDSC end		
	...
	protected void onDestroy () {
		...
		CommonLog.i ( "MoaiActivity onDestroy: activity DESTROYED" );
	...
	protected void onNewIntent ( Intent intent ) {
		...
		CommonLog.i ( "MoaiActivity onNewIntent: application started from NEW INTENT" );
		
		Moai.onNewIntent(intent);
	...
	protected void onPause () {
		...
		CommonLog.i ( "MoaiActivity onPause: activity PAUSED" );
		// CDSC PATCH
...
//				);				
		...
		CommonLog.i ( "MoaiActivity onPause: PAUSING now" );
	...
	protected void onResume () {
		...
		CommonLog.i ( "MoaiActivity onResume: activity RESUMED" );
...
//CSDC_PATCH_POWER
		...
		if ( !mWindowFocusLost ) {
			...
			CommonLog.i ( "MoaiActivity onResume: RESUMING now" );
	...
	protected void onStart () {
		...
		CommonLog.i ( "MoaiActivity onStart: activity STARTED" );
	...
	protected void onStop () {
		...
		CommonLog.i ( "MoaiActivity onStop: activity STOPPED" );
	...
	public boolean onKeyDown ( int keyCode, KeyEvent event ) {
		...
		CommonLog.i ("MoaiActivity onKeyDown, keycode " + keyCode + " event: " + event );
	...
	public void onWindowFocusChanged ( boolean hasFocus ) {
		...
		CommonLog.i ( "MoaiActivity onWindowFocusChanged: activity FOCUS CHANGED" );
		...
		if ( mWaitingToResume && hasFocus ) {
			...
			CommonLog.i ( "MoaiActivity onWindowFocusChanged: RESUMING now" );
			mMoaiView.pause ( false );
		}
	}
	...
	public void onConfigurationChanged(Configuration newConfig) {
		...
		if (newConfig.hardKeyboardHidden == Configuration.HARDKEYBOARDHIDDEN_NO) {
		    CommonLog.d("HARDKEYBOARDHIDDEN_NO");
		} else if (newConfig.hardKeyboardHidden == Configuration.HARDKEYBOARDHIDDEN_YES) {
		    CommonLog.d("HARDKEYBOARDHIDDEN_YES");
		}
		}
	...
	private class ConnectivityBroadcastReceiver extends BroadcastReceiver {
		...
		public void onReceive ( Context context, Intent intent ) {
			...
			CommonLog.i ( "ConnectivityBroadcastReceiver onReceive: Connection = " + connectionType );
