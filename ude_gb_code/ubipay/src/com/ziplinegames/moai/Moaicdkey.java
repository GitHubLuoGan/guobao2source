...
public static String V2_getCdkey(JsonValue parms){
	if(!CommonTool.checkNetworkAvailable(MoaiBaseSdk.sActivity)){
		CommonTool.showDialog("提示信息", "请先连接网络");
		return "false";
	}
